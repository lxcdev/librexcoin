    ...
    model(0)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a LibrexCoin address (e.g. LibrexCoinfwYhBmGXcFP2Po1NpRUEiK8km2)"));
#endif
...
void SendCoinsDialog::coinControlChangeEdited(const QString & text)
{
    if (model)
    {
        ...
        else if (!CBitcoinAddress(text.toStdString()).IsValid())
        {
            ...
            ui->labelCoinControlChangeLabel->setText(tr("WARNING: Invalid LibrexCoin address"));
        }
        else
        {
