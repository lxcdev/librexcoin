...
unsigned int nStakeMaxAge = 8 * 60 * 60; // 8 hours          // unlimited
...
const string strMessageMagic = "LibrexCoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "LibrexCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Librexcoin is the new global and liberal cryptocurrency for all.";
        CTransaction txNew;
        txNew.nTime = 1406667957; //1405344502
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1406667957;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 4828690;
		if(fTestNet)
        {
            block.nNonce   = 0;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("d6c43b1a604c877e1d5b3829a0e2187a95d929d794d5f9f2719161617d0f7be8"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xa2, 0xa2, 0xa2, 0xa2 };
