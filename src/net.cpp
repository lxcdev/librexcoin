...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("LibrexCoin-ext-ip");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "LibrexCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {		//seednodes
	{"192.99.223.96", "192.99.223.96"},
	{"192.227.251.74", "192.227.251.74"},
	{"198.23.178.87", "198.23.178.87"},
	{"23.94.38.173", "23.94.38.173"},	
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("LibrexCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("LibrexCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("LibrexCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("LibrexCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. LibrexCoin is probably already running."), addrBind.ToString().c_str());
        else
